...
export const open = async (sessionId: string): Promise<void> => {
  await DirectViewWorker.invoke('MainArea', 'Main.openUri', `chat-debug://${sessionId}`)
}
...
export const handleTimelineDoubleClick = async (): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handleTimelineDoubleClick')
}

export const setEvents = async (events: readonly ChatDebugEvent[]): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.setEvents', events)
}

export const toggleHeadersSection = async (sectionId: string): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handleInput', 'toggleHeadersSection', sectionId, false)
}

export const setIndexedDbSupportForTest = async (supported: boolean): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.setIndexedDbSupportForTest', supported)
}

export const handleRootContextMenu = async (): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handleRootContextMenu')
}

export const resetIndexedDbSupportForTest = async (): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.setIndexedDbSupportForTest')
}

export const selectEventRow = async (index: number): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handleEventRowClick', String(index))
}
...
export const shouldHavePayload = async (expectedPayload: unknown): Promise<void> => {
  ...
  try {
    await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.shouldHavePayload', expectedPayload)
  } catch (error) {
...
export const shouldHavePayload2 = async (expectedPayload: unknown): Promise<void> => {
  const actualPayload = await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.getPayload')
...
export const shouldHaveResponse = async (expectedPayload: unknown): Promise<void> => {
  const actualPayload = await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.getResponse')
  try {
...
export const handleInput = async (name: ChatDebugInputName, value: string, checked: boolean): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handleInput', name, value, checked)
}
...
export const handleHeaderContextMenu = async (x: number, y: number): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handleHeaderContextMenu', x, y)
}
...
export const handlePreviewTextPointerDown = async (x: number, y: number): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handlePreviewTextPointerDown', x, y)
}
...
export const handleTableFocus = async (): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handleTableFocus')
}
...
export const openTab = async (id: string): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handleInput', 'detailTab', id, false)
}
...
export const handleTimelinePointerDown = async (name: string, x: number, y: number): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handleTimelinePointerDown', name, x, y)
}

export const handleTimelinePointerMove = async (x: number): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handleTimelinePointerMove', x)
}

export const handleTimelinePointerUp = async (x: number): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handleTimelinePointerUp', x)
}
...
export const setSessionId = async (sessionId: string): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.setSessionId', sessionId)
}

export const appendStoredEventForTest = async (event: any): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.appendStoredEventForTest', event)
}

export const handleClickRefresh = async (): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handleClickRefresh')
}
...
export const handleEventCategoryFilter = async (filter: ChatDebugCategoryId): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handleEventCategoryFilter', filter)
}

export const handleTableBodyContextMenu = async (x: number, y: number): Promise<void> => {
  await DirectViewWorker.invoke('ChatDebug', 'ChatDebug.handleTableBodyContextMenu', x, y)
}
