...
import * as Git from '../TestFrameWorkComponentGit/TestFrameWorkComponentGit.ts'
...
import * as WorkersView from '../TestFrameWorkComponentWorkersView/TestFrameWorkComponentWorkersView.ts'
