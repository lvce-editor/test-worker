...
test('createApi includes all expected components', () => {
  ...
  expect(api.ChatView2.show).toBeDefined()
  ...
  expect(api.Devcontainer.start).toBeDefined()
  ...
  expect(api.MarkdownPreview).toBeDefined()
  ...
  expect(api.SecretsView).toBeDefined()
  ...
  expect(api.WorkersView.open).toBeDefined()
